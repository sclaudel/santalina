...
function exportStatsToPdf(stats: StatsResponse, filterYear: string, filterMonth: string) {
  ...
  if (stats.bestDayDate)    kpiBody.push(['Meilleure journée', `${dayjs(stats.bestDayDate).format('DD/MM/YYYY')} (${stats.bestDayDivers} plg.)`]);
        ...
        <>
          ...
          <div className="stats-totals">
            <div className="stats-total-card">
              ...
              <span className="stats-total-label">Créneaux</span>
            </div>
            <div className="stats-total-card">
              <span className="stats-total-icon">🏊</span>
